...
BASE_SYSTEM = (
    ...
    "конкретной роли и компании из вакансии; в конце — вопрос о следующем шаге. "
    ...
    "только из профиля кандидата. Без markdown, без темы письма, без подписи — "
